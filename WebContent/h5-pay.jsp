...
<body>
<form action="h5Pay" method="post">
<div class="error_500">
<h1>金运通H5支付测试页面</h1>
<table>
 <tr>
    <td>merchant_id</td> 
    <td><input name="merchantId" value="290058120016"/>&nbsp;&nbsp;商户号</td> <!-- 290058120016 391079330001 -->
  </tr>
  <tr>
    <td>pay_channel</td> 
   ...
   <tr>
    <td>pay_mode</td> 
    <td><input name="payMode" value="05" readonly="readonly"/>&nbsp;&nbsp;支付模式</td>
  </tr>
   <tr>
    <td>order_id</td> 
   ...
   <tr>
    <td>total_amt</td> 
    <td><input name="totalAmt" value="0.01"/>&nbsp;&nbsp;支付金额</td>
  </tr>
   <tr>
    <td>subject</td> 
   ...
   <tr>
    ...
    <td><input name="spbillCreatIp" value="127.0.0.1"/>&nbsp;&nbsp;支付ip</td>
  </tr>
  <tr>
    <td></td>
