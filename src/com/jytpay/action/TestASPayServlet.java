 ...
 *
 */
public class TestASPayServlet extends HttpServlet {
	...
	public static String APP_SERVER_URL = "aspay-commit.jsp";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String imgUrl = tradeResp.getBody().getCodeImgUrl();
		if (imgUrl != null) {
			resp.sendRedirect(APP_SERVER_URL + "?imgurl=" + imgUrl);
		} else {
			resp.getWriter().write(JSONObject.toJSONString(imgUrl));
		}
	}
