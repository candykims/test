...
public class TestPSPayServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	public static String ONEPAY_SERVER_URL = "https://test.jytpay.com/onePayService/dev/onePay.do";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().write(JSONObject.toJSONString(respMsgContext));
